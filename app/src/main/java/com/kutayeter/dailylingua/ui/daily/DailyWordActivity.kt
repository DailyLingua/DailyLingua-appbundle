package com.kutayeter.dailylingua.ui.daily
...
import com.kutayeter.dailylingua.R
...
class DailyWordActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        ...
        mainCard = findViewById(com.kutayeter.dailylingua.R.id.main_card)
    }

    private fun setupButtonClickListeners() {
        findViewById<Button>(R.id.btn_quiz).setOnClickListener {
            startActivity(Intent(this, com.kutayeter.dailylingua.ui.quiz.QuizActivity::class.java))
        }

        // Dictionary navigation button (placed under Quiz)
        findViewById<Button>(R.id.btn_dictionary_nav).setOnClickListener {
            startActivity(Intent(this, com.kutayeter.dailylingua.ui.dictionary.DictionaryActivity::class.java))
        }

        findViewById<Button>(R.id.btn_progress).setOnClickListener {
            startActivity(Intent(this, com.kutayeter.dailylingua.ui.progress.ProgressActivity::class.java))
        }
        // Open MistakesActivity directly from main screen
        findViewById<Button>(R.id.btn_view_mistakes_main).setOnClickListener {
            startActivity(Intent(this, com.kutayeter.dailylingua.ui.mistakes.MistakesActivity::class.java))
        }
    }
