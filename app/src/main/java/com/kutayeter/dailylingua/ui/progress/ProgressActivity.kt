package com.kutayeter.dailylingua.ui.progress
...
class ProgressActivity : AppCompatActivity() {
    ...
    tvWrongCount.text = getString(R.string.wrong_count, wrongAnswers)
        ...
        findViewById<android.widget.Button>(R.id.btn_view_mistakes).setOnClickListener {
            startActivity(android.content.Intent(this, com.kutayeter.dailylingua.ui.mistakes.MistakesActivity::class.java))
        }
    }
